...
for (const path of ['/privacy.html', '/consent.html', '/robots.txt', '/sitemap.xml', '/app.js?v=20260919-2', '/phone-mask.js?v=20260919-1', '/form-fields.js?v=20260919-1', '/styles.css', '/assets/salkn-logo.png']) {
...
for (const [label, value] of [['consent',{...payload,consent:false}],['phone',{...payload,phone:'invalid'}],['phone too long',{...payload,phone:'+7999123456789'}],['phone incomplete',{...payload,phone:'+7999123456'}],['name length',{...payload,name:'А'.repeat(61)}],['name characters',{...payload,name:'Иван123'}],['name without letters',{...payload,name:'---'}],['brand',{...payload,brand:'Unknown'}],['honeypot',{...payload,website:'spam'}],['comment length',{...payload,comment:'x'.repeat(1001)}]]) {
